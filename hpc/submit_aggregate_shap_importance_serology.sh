...
INPUT_FILE="${BASE_DIR}/results_GitHub/single_modal/serology/shap_global_importance.csv"
OUTPUT_FILE="${BASE_DIR}/results_GitHub/single_modal/serology/shap_global_importance_aggregated.csv"
