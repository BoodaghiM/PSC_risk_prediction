...
SHAP_PATH="${BASE_DIR}/results_GitHub/single_modal/genetics/shap_global_importance.csv"

# Output
OUT_DIR="${BASE_DIR}/results_GitHub/single_modal/genetics"
OUT_FILE="${OUT_DIR}/shap_global_importance_annotated.csv"
mkdir -p "${OUT_DIR}"
