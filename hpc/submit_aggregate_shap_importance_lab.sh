...
INPUT_FILE="${BASE_DIR}/results_GitHub/single_modal/lab/shap_global_importance.csv"
OUTPUT_FILE="${BASE_DIR}/results_GitHub/single_modal/lab/shap_global_importance_aggregated.csv"
